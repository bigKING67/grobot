...
} from "../status-line/render";
import type { BottomPanePromptInput } from "./contract";
import { TERMINAL_ANSI, terminalStyle } from "../../theme/terminal-style";
import { renderReactBottomPaneLines } from "../../react/bottom-pane";

export type { BottomPanePromptInput } from "./contract";
...
export function renderBottomPaneFooter(input: BottomPanePromptInput): string {
  ...
  return renderReactBottomPaneLines({
    lines,
    terminalColumns: input.terminalColumns,
  });
}
