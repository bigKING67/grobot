...
export function usage(): string {
  return [
    ...
    "",
    "Commands:",
    "  status [--project <name>] [--work-dir <dir>] [--home <dir>] [--project-root <dir>] [--config <path>] [--provider <name>] [--api-key <key>] [--base-url <url>] [--model <id>] [--probe] [--json] [--context-graph-cache-window-size <n>] [--context-graph-cache-degrade-hit-rate <0..1>] [--context-graph-cache-degrade-min-entries <n>] [--gateway-impl ts] [--runtime-impl rust] [--shadow-mode|--no-shadow-mode]",
