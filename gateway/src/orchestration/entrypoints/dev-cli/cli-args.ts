...
export function usage(): string {
  return [
    ...
    "",
    "Commands:",
    "  status [--project <name>] [--work-dir <dir>] [--home <dir>] [--project-root <dir>] [--config <path>] [--provider <name>] [--api-key <key>] [--base-url <url>] [--model <id>] [--probe] [--json] [--gateway-impl ts] [--runtime-impl rust] [--shadow-mode|--no-shadow-mode]",
