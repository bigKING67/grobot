...
function createStatusLineControlFlow(context) {
  const {
    repoRoot,
    createTempDir,
    buildSmokeConfig,
...
export function runStartInvalidStatusLineBasicControlsRejectFlow(context) {
  const { makeCase, hasStartBannerMarker } = createStatusLineControlFlow(context);
...
export function runStartInvalidStatusLineSegmentOrderControlsRejectFlow(context) {
  const { makeCase, hasStartBannerMarker } = createStatusLineControlFlow(context);
...
export function runStartInvalidStatusLineThresholdControlsRejectFlow(context) {
  const { makeCase, hasStartBannerMarker } = createStatusLineControlFlow(context);
...
export function runStartInvalidStatusLineCacheControlsRejectFlow(context) {
  const { makeCase, hasStartBannerMarker } = createStatusLineControlFlow(context);
...
export function runStartInvalidStatusLineSegmentToggleControlsRejectFlow(context) {
  const { makeCase, hasStartBannerMarker } = createStatusLineControlFlow(context);
...
export function runStartStatusLineValidBoundaryFlow(context) {
  const { makeCase } = createStatusLineControlFlow(context);
...
export function runStartInvalidStatusLineControlsRejectFlow(context) {
  const basicControls = runStartInvalidStatusLineBasicControlsRejectFlow(context);
  const segmentOrderControls = runStartInvalidStatusLineSegmentOrderControlsRejectFlow(context);
  const thresholdControls = runStartInvalidStatusLineThresholdControlsRejectFlow(context);
  const cacheControls = runStartInvalidStatusLineCacheControlsRejectFlow(context);
  const segmentToggleControls = runStartInvalidStatusLineSegmentToggleControlsRejectFlow(context);
  return {
    ...basicControls,
    ...segmentOrderControls,
    ...thresholdControls,
    ...cacheControls,
    ...segmentToggleControls,
    ...runStartStatusLineValidBoundaryFlow(context),
    hides_top_level_fatal:
      basicControls.hides_top_level_fatal
      && segmentOrderControls.hides_top_level_fatal
      && thresholdControls.hides_top_level_fatal
      && cacheControls.hides_top_level_fatal
      && segmentToggleControls.hides_top_level_fatal,
    has_start_banner:
      basicControls.has_start_banner
      || segmentOrderControls.has_start_banner
      || thresholdControls.has_start_banner
      || cacheControls.has_start_banner
      || segmentToggleControls.has_start_banner,
  };
}
