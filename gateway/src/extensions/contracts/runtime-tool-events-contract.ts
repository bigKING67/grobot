...
process.stdout.write(JSON.stringify({
  ...
  feedback_prompt_budget_within_limit: oversizedFeedback.promptBlock.length <= RUNTIME_TOOL_RECOVERY_PROMPT_MAX_CHARS,
  feedback_prompt_budget_truncated_details: oversizedFeedback.promptBlock.includes("Details truncated: omitted"),
