...
export async function runRuntimeInteractivePlanFlowSmoke() {
  ...
  assert.equal(sessionMenuViewModelPayload.sessions_title, "Sessions");
  ...
  assert.equal(sessionMenuViewModelPayload.sessions_subtitle, "2 sessions · current Main Session");
  ...
  assert.equal(sessionMenuViewModelPayload.sessions_hub_title, "Sessions");
  assert.equal(sessionMenuViewModelPayload.sessions_hub_subtitle, "2 sessions · current Main Session");
  ...
  assert.equal(sessionMenuViewModelPayload.switch_subtitle, "2 sessions · choose current context");
  assert.equal(sessionMenuViewModelPayload.continue_subtitle, "2 sessions · choose summary source");
  assert.equal(sessionMenuViewModelPayload.resume_subtitle, "2 sessions · choose resume source");
  assert.equal(sessionMenuViewModelPayload.rewind_subtitle, "2 sessions · choose rewind source");
