...
export async function runTuiContracts() {
  ...
  assertPayloadFlags(cliUiRendererContractPayload, [
    ...
    "menu_viewport_has_no_more_text", "menu_direct_render_uses_default_visible_count",
    ...
    "plan_approval_menu_has_ready_title", "plan_approval_menu_has_planning_path_header",
    "plan_approval_menu_title_is_not_plan_color_flooded", "plan_approval_menu_has_subtitle",
    "plan_approval_menu_embeds_plan_markdown", "plan_approval_menu_separates_plan_actions_and_footer",
    ...
    "plan_approval_menu_shows_inline_feedback_input", "plan_approval_menu_shows_inline_feedback_cursor",
    "plan_approval_menu_preserves_feedback_after_reopen", "plan_approval_menu_uses_plan_mode_color",
    "plan_approval_menu_has_no_default_thin_pointer", "plan_approval_menu_sanitizes_untrusted_payload",
    ...
    "menu_hide_indexes_omits_numeric_indexes", "menu_hide_indexes_keeps_pointer",
