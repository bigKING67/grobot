...
export async function runMemoryContracts() {
  ...
  assert.equal(interactiveBindingsPayload.health_hides_raw_sticky_label, true);
  assert.equal(interactiveBindingsPayload.health_hides_raw_session_namespace, true);
  assert.equal(interactiveBindingsPayload.health_has_provider_row, true);
  assert.equal(interactiveBindingsPayload.health_hides_raw_status_codes, true);
  assert.equal(interactiveBindingsPayload.health_hides_raw_rpm_burst_labels, true);
  assert.equal(interactiveBindingsPayload.health_uses_human_cooldown, true);
  assert.equal(interactiveBindingsPayload.context_status_has_header, true);
  assert.equal(interactiveBindingsPayload.context_status_uses_human_subtitle, true);
  ...
  assert.equal(interactiveBindingsPayload.memory_status_uses_human_subtitle, true);
  ...
  assert.equal(interactiveBindingsPayload.skills_status_uses_human_subtitle, true);
  ...
  assert.equal(interactiveBindingsPayload.mcp_status_uses_human_subtitle, true);
  assert.equal(interactiveBindingsPayload.history_status_uses_human_subtitle, true);
  ...
  assert.equal(interactiveBindingsPayload.status_snapshot_uses_human_segment_labels, true);
  assert.equal(interactiveBindingsPayload.status_segment_update_notice_is_human, true);
  ...
  assert.equal(modelOpsContractPayload.model_menu_omits_noisy_default_descriptions, true);
